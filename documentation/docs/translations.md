...
| `NextSeriesMapInfoMessage`                  | The next map in the series is _de_nuke_.                                                                                                                                 | Chat       |
...
| `TeamsSplitSeriesBO2InfoMessage`            | _Team A_ and _Team B_ have split the series 1-1.                                                                                                                         | Chat       |
