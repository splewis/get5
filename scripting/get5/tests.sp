...
static void KV_Test() {
  ...
  AssertTrue("team1.logo", StrEqual(g_TeamConfig[MatchTeam_Team1].logo, "nv", false));

  AssertTrue("team2.name", StrEqual(g_TeamConfig[MatchTeam_Team2].name, "fnatic", false));
  AssertTrue("team2.flag", StrEqual(g_TeamConfig[MatchTeam_Team2].flag, "SE", false));
  AssertTrue("team2.logo", StrEqual(g_TeamConfig[MatchTeam_Team2].logo, "fntc", false));
}
